...
pub fn register_all(factory: &mut AnalysisFactory) {
    // Tokenizers
    factory.register_tokenizer_with("ik_smart", || Box::new(IkTokenizer::new(IkConfig::default().mode(IkMode::Smart))));
    factory.register_tokenizer_with("ik_max_word", || Box::new(IkTokenizer::new(IkConfig::default().mode(IkMode::MaxWord))));
